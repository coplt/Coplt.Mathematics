    ...
    , IEqualityOperators<b16, b16, bool>
{
    ...
    public readonly override string ToString() => ((bool)this) ? "true" : "false";
    ...
    {
        charsWritten = 0;
        return FormatUtils.TryFormatPart(ref destination, ref charsWritten, ((bool)this) ? "true" : "false");
    }
    ...
    {
        charsWritten = 0;
        return FormatUtils.TryFormatPart(ref destination, ref charsWritten, ((bool)this) ? "true"u8 : "false"u8);
    }
