...
namespace Coplt.Mathematics
{
    public static partial class math
    {
        ...
        public static TScalar hmin<T, TScalar>(in T value)
            ...
            => T.Visit_Scalar<impl_horizontal_min>(value);
    }
}
...
{
    /// <summary>
    /// The smallest component of a value
    ...
    /// </summary>
    internal struct impl_horizontal_min : INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min>
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min>.AcceptScalar<TScalar>(TScalar value) => value;

        // the smallest component of a matrix is the one of every column of it combined with the one of the next
        // column
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min>.AcceptCombine<TScalar>(TScalar a, TScalar b)
            => TScalar.Min(a, b);

        // every lane of a 64 bit register is a component of the value
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min>.AcceptVector<TVector, TScalar>(in Vector64<TScalar> vector)
        {
            return TScalar.Min(vector[0], vector[1]);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min>.AcceptVector<TVector, TScalar>(in Vector128<TScalar> vector)
        {
                ...
                if (AdvSimd.Arm64.IsSupported)
                {
                    if (typeof(TScalar) == typeof(float) || typeof(TScalar) == typeof(int) || typeof(TScalar) == typeof(uint))
                    {
                        ...
                        if (typeof(TScalar) == typeof(float))
                            return AdvSimd.Arm64.MinNumberAcross(s.AsSingle()).As<float, TScalar>().ToScalar();
            ...
            if (TVector.Rows == 3) return TScalar.Min(TScalar.Min(vector[0], vector[1]), vector[2]);
            return TScalar.Min(TScalar.Min(vector[0], vector[1]), TScalar.Min(vector[2], vector[3]));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min>.AcceptVector<TVector, TScalar>(in Vector256<TScalar> vector)
        {
        ...
        // combined
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min>.AcceptVector2<TVector, TScalar>(in TVector vector)
            => TScalar.Min(TVector.get_x(vector), TVector.get_y(vector));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min>.AcceptVector3<TVector, TScalar>(in TVector vector)
            => TScalar.Min(TScalar.Min(TVector.get_x(vector), TVector.get_y(vector)), TVector.get_z(vector));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min>.AcceptVector4<TVector, TScalar>(in TVector vector)
