...
namespace Coplt.Mathematics
{
    ...
    {
        /// <summary>
        /// Returns the smallest component of the value
        ...
        /// <returns>The smallest component of the value</returns>
        ...
        public static TScalar hmin_native<T, TScalar>(in T value)
            ...
            => T.Visit_Scalar<impl_horizontal_min_native>(value);
    }
}
...
{
    /// <summary>
    /// The smallest component of a value, the one the platform computes itself
    ...
    /// smallest component of every column of it</para>
    /// </summary>
    internal struct impl_horizontal_min_native : INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min_native>
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min_native>.AcceptScalar<TScalar>(TScalar value) => value;

        // the smallest component of a matrix is the one of every column of it combined with the one of the next
        // column
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min_native>.AcceptCombine<TScalar>(TScalar a, TScalar b)
            => TScalar.MinNative(a, b);

        // every lane of a 64 bit register is a component of the value
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min_native>.AcceptVector<TVector, TScalar>(in Vector64<TScalar> vector)
        {
            return TScalar.MinNative(vector[0], vector[1]);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min_native>.AcceptVector<TVector, TScalar>(in Vector128<TScalar> vector)
        {
            ...
            if (Vector128.IsHardwareAccelerated)
            {
                if (AdvSimd.Arm64.IsSupported)
                {
                    if (typeof(TScalar) == typeof(float) || typeof(TScalar) == typeof(int) || typeof(TScalar) == typeof(uint))
                    {
                        ...
                        if (typeof(TScalar) == typeof(float))
                            return AdvSimd.Arm64.MinAcross(s.AsSingle()).As<float, TScalar>().ToScalar();

                        if (typeof(TScalar) == typeof(int))
                            return AdvSimd.Arm64.MinAcross(s.AsInt32()).As<int, TScalar>().ToScalar();

                        if (typeof(TScalar) == typeof(uint))
                            return AdvSimd.Arm64.MinAcross(s.AsUInt32()).As<uint, TScalar>().ToScalar();
                    }
                }
                ...
                if (TVector.Rows == 3)
                {
                    ...
                    var r1 = Vector128.MinNative(vector, s1);
                    var s2 = Vector128.Shuffle(r1.AsInt32(), Vector128.Create(1, 0, 0, 0)).As<int, TScalar>();
                    return Vector128.MinNative(r1, s2).ToScalar();
                }
                else
                {
            ...
            if (TVector.Rows == 3) return TScalar.MinNative(TScalar.MinNative(vector[0], vector[1]), vector[2]);
            return TScalar.MinNative(TScalar.MinNative(vector[0], vector[1]), TScalar.MinNative(vector[2], vector[3]));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min_native>.AcceptVector<TVector, TScalar>(in Vector256<TScalar> vector)
        {
            if (Vector256.IsHardwareAccelerated)
            {
                if (TVector.Rows == 3)
                {
                    ...
                    var r1 = Vector256.MinNative(vector, s1);
                    var s2 = Vector256.Shuffle(r1.AsInt64(), Vector256.Create(1, 0, 0, 0)).As<long, TScalar>();
                    return Vector256.MinNative(r1, s2).ToScalar();
                }
                else
                {
        ...
        // combined
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min_native>.AcceptVector2<TVector, TScalar>(in TVector vector)
            => TScalar.MinNative(TVector.get_x(vector), TVector.get_y(vector));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min_native>.AcceptVector3<TVector, TScalar>(in TVector vector)
            => TScalar.MinNative(TScalar.MinNative(TVector.get_x(vector), TVector.get_y(vector)), TVector.get_z(vector));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static TScalar INumberAlgebraVisitor_Self_Scalar<impl_horizontal_min_native>.AcceptVector4<TVector, TScalar>(in TVector vector)
