...
public static partial class simd
{
    ...
    public static Vector64<float> Mod(Vector64<float> a, Vector64<float> b)
    {
        ...
        return Vector64.Create(
            a.GetElement(0) - b.GetElement(0) * float.Floor(a.GetElement(0) / b.GetElement(0)),
            a.GetElement(1) - b.GetElement(1) * float.Floor(a.GetElement(1) / b.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Mod(Vector128<double> a, Vector128<double> b)
    {
        ...
        return Vector128.Create(
            a.GetElement(0) - b.GetElement(0) * double.Floor(a.GetElement(0) / b.GetElement(0)),
            a.GetElement(1) - b.GetElement(1) * double.Floor(a.GetElement(1) / b.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Mod(Vector64<float> a, float b)
    {
        ...
        return Vector64.Create(
            a.GetElement(0) - b * float.Floor(a.GetElement(0) / b),
            a.GetElement(1) - b * float.Floor(a.GetElement(1) / b)
        );
    }
    ...
    public static Vector128<double> Mod(Vector128<double> a, double b)
    {
        ...
        return Vector128.Create(
            a.GetElement(0) - b * double.Floor(a.GetElement(0) / b),
            a.GetElement(1) - b * double.Floor(a.GetElement(1) / b)
        );
    }
    ...
    public static Vector64<float> ModF(Vector64<float> d, out Vector64<float> i)
    {
        ...
        i = Vector64.Create(float.Truncate(d.GetElement(0)), float.Truncate(d.GetElement(1)));
        return d - i;
    }
    ...
    public static Vector128<double> ModF(Vector128<double> d, out Vector128<double> i)
    {
        ...
        i = Vector128.Create(double.Truncate(d.GetElement(0)), double.Truncate(d.GetElement(1)));
        return d - i;
    }
    ...
    public static Vector64<float> Log(Vector64<float> d)
    {
        ...
        return Vector64.Create(
            float.Log(d.GetElement(0)),
            float.Log(d.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Log(Vector128<double> d)
    {
        ...
        return Vector128.Create(
            double.Log(d.GetElement(0)),
            double.Log(d.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Log2(Vector64<float> d)
    {
        ...
        return Vector64.Create(
            float.Log2(d.GetElement(0)),
            float.Log2(d.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Log2(Vector128<double> d)
    {
        ...
        return Vector128.Create(
            double.Log2(d.GetElement(0)),
            double.Log2(d.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Log10(Vector64<float> d)
    {
        ...
        return Vector64.Create(
            float.Log10(d.GetElement(0)),
            float.Log10(d.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Log10(Vector128<double> d)
    {
        ...
        return Vector128.Create(
            double.Log10(d.GetElement(0)),
            double.Log10(d.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Exp(Vector64<float> d)
    {
        ...
        return Vector64.Create(
            float.Exp(d.GetElement(0)),
            float.Exp(d.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Exp(Vector128<double> d)
    {
        ...
        return Vector128.Create(
            double.Exp(d.GetElement(0)),
            double.Exp(d.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Exp2(Vector64<float> d)
    {
        ...
        return Vector64.Create(
            float.Exp2(d.GetElement(0)),
            float.Exp2(d.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Exp2(Vector128<double> d)
    {
        ...
        return Vector128.Create(
            double.Exp2(d.GetElement(0)),
            double.Exp2(d.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Exp10(Vector64<float> d)
    {
        ...
        return Vector64.Create(
            float.Exp10(d.GetElement(0)),
            float.Exp10(d.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Exp10(Vector128<double> d)
    {
        ...
        return Vector128.Create(
            double.Exp10(d.GetElement(0)),
            double.Exp10(d.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Pow(Vector64<float> a, Vector64<float> b)
    {
        ...
        return Vector64.Create(
            float.Pow(a.GetElement(0), b.GetElement(0)),
            float.Pow(a.GetElement(1), b.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Pow(Vector128<double> a, Vector128<double> b)
    {
        ...
        return Vector128.Create(
            double.Pow(a.GetElement(0), b.GetElement(0)),
            double.Pow(a.GetElement(1), b.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Pow(Vector64<float> a, float b)
    {
        ...
        return Vector64.Create(
            float.Pow(a.GetElement(0), b),
            float.Pow(a.GetElement(1), b)
        );
    }
    ...
    public static Vector128<double> Pow(Vector128<double> a, double b)
    {
        ...
        return Vector128.Create(
            double.Pow(a.GetElement(0), b),
            double.Pow(a.GetElement(1), b)
        );
    }
    ...
    public static Vector64<float> Tan(Vector64<float> a)
    {
        ...
        return Vector64.Create(
            float.Tan(a.GetElement(0)),
            float.Tan(a.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Tan(Vector128<double> a)
    {
        ...
        return Vector128.Create(
            double.Tan(a.GetElement(0)),
            double.Tan(a.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Sinh(Vector64<float> a)
    {
        ...
        return Vector64.Create(
            float.Sinh(a.GetElement(0)),
            float.Sinh(a.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Sinh(Vector128<double> a)
    {
        ...
        return Vector128.Create(
            double.Sinh(a.GetElement(0)),
            double.Sinh(a.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Cosh(Vector64<float> a)
    {
        ...
        return Vector64.Create(
            float.Cosh(a.GetElement(0)),
            float.Cosh(a.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Cosh(Vector128<double> a)
    {
        ...
        return Vector128.Create(
            double.Cosh(a.GetElement(0)),
            double.Cosh(a.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Tanh(Vector64<float> a)
    {
        ...
        return Vector64.Create(
            float.Tanh(a.GetElement(0)),
            float.Tanh(a.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Tanh(Vector128<double> a)
    {
        ...
        return Vector128.Create(
            double.Tanh(a.GetElement(0)),
            double.Tanh(a.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Asinh(Vector64<float> a)
    {
        ...
        return Vector64.Create(
            float.Asinh(a.GetElement(0)),
            float.Asinh(a.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Asinh(Vector128<double> a)
    {
        ...
        return Vector128.Create(
            double.Asinh(a.GetElement(0)),
            double.Asinh(a.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Acosh(Vector64<float> a)
    {
        ...
        return Vector64.Create(
            float.Acosh(a.GetElement(0)),
            float.Acosh(a.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Acosh(Vector128<double> a)
    {
        ...
        return Vector128.Create(
            double.Acosh(a.GetElement(0)),
            double.Acosh(a.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Atanh(Vector64<float> a)
    {
        ...
        return Vector64.Create(
            float.Atanh(a.GetElement(0)),
            float.Atanh(a.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Atanh(Vector128<double> a)
    {
        ...
        return Vector128.Create(
            double.Atanh(a.GetElement(0)),
            double.Atanh(a.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Asin(Vector64<float> a)
    {
        ...
        return Vector64.Create(
            float.Asin(a.GetElement(0)),
            float.Asin(a.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Asin(Vector128<double> a)
    {
        ...
        return Vector128.Create(
            double.Asin(a.GetElement(0)),
            double.Asin(a.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Acos(Vector64<float> a)
    {
        ...
        return Vector64.Create(
            float.Acos(a.GetElement(0)),
            float.Acos(a.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Acos(Vector128<double> a)
    {
        ...
        return Vector128.Create(
            double.Acos(a.GetElement(0)),
            double.Acos(a.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Atan(Vector64<float> a)
    {
        ...
        return Vector64.Create(
            float.Atan(a.GetElement(0)),
            float.Atan(a.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Atan(Vector128<double> a)
    {
        ...
        return Vector128.Create(
            double.Atan(a.GetElement(0)),
            double.Atan(a.GetElement(1))
        );
    }
    ...
    public static Vector64<float> Atan2(Vector64<float> y, Vector64<float> x)
    {
        ...
        return Vector64.Create(
            float.Atan2(y.GetElement(0), x.GetElement(0)),
            float.Atan2(y.GetElement(1), x.GetElement(1))
        );
    }
    ...
    public static Vector128<double> Atan2(Vector128<double> y, Vector128<double> x)
    {
        ...
        return Vector128.Create(
            double.Atan2(y.GetElement(0), x.GetElement(0)),
            double.Atan2(y.GetElement(1), x.GetElement(1))
        );
    }
