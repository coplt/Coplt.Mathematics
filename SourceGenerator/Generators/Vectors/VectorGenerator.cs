...
/// floating point members by <c>GenFloat</c>, the ieee 754 members by <c>GenIeee</c>, the as members and
/// the conversions between a vector and its storage variant by <c>GenAs</c> and the as members of the math
